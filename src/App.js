...
import logo from "./Resourses/Images/Greenland_Magazine.png"
          ...
          <header className="header">
            ...
            <section className="program-description-section-single"> 
              <div className="program-description">
                <h2>Greenland Magazine 2023</h2>
                <img src={logo} alt="Greenland Magazine 2023"/>
                <MyButton
                  link="https://www.e-pages.dk/plb/155/"
                  linkName="DOWNLOAD"
                  id={`${this.props.uid}`}
                />
              </div>
